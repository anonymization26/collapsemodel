...
RESULT_ROOT="${RESULT_ROOT:-/data/Paper06/results/two_stage_repeated_cv_utility_corrected_v3/folds_5_seeds_20260905_20260906_20260907}"
...
for encoder in "$@"; do
  ...
  python3 -u scripts/two_stage_natural_shortlist.py adapt \
    ...
    --target-cv-folds 5 \
    --target-cv-seeds 20260905 20260906 20260907 \
    --seed-start 0 \
    --n-seeds 5 \
    --width 256 \
    --steps 600 \
